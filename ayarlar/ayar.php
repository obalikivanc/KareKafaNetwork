...
$baslik 			= "TufanGencel PANEL"; // Sitenin Pencere bölümünde yazan yazı //
$aciklama 			= "CraftRosi Sahibi"; // Google'da çıktığınızda sitenin açıklama kısmı //
...
$site_url 			= "http://siteadı"; // Sitenizin URL'sini yazın sonunda "/" olmasın! //
